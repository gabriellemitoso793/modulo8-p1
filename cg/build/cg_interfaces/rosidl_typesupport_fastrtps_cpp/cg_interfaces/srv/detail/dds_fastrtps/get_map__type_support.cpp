...
#include "cg_interfaces/srv/detail/get_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cg_interfaces::srv::GetMap_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cg_interfaces::srv::GetMap_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_interfaces::srv::GetMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_interfaces::srv::GetMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cg_interfaces::srv::GetMap_Request *>(
    untyped_ros_message);
...
{
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_interfaces, srv, GetMap_Request)() {
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cg_interfaces
cdr_serialize(
  const cg_interfaces::srv::GetMap_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: occupancy_grid_flattened
  {
    cdr << ros_message.occupancy_grid_flattened;
  }
  // Member: occupancy_grid_shape
  {
    ...
    if (size > 0) {
      cdr.serializeArray(&(ros_message.occupancy_grid_shape[0]), size);
    }
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cg_interfaces::srv::GetMap_Response & ros_message)
{
  // Member: occupancy_grid_flattened
  {
    cdr >> ros_message.occupancy_grid_flattened;
  ...
  // Member: occupancy_grid_shape
  {
    ...
    ros_message.occupancy_grid_shape.resize(size);
    if (size > 0) {
      cdr.deserializeArray(&(ros_message.occupancy_grid_shape[0]), size);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: occupancy_grid_flattened
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.occupancy_grid_flattened[index].size() + 1);
    }
  }
  // Member: occupancy_grid_shape
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.occupancy_grid_shape[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cg_interfaces::srv::GetMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_interfaces::srv::GetMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cg_interfaces::srv::GetMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_interfaces, srv, GetMap_Response)() {
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap_Response__handle;
}
...
{
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_interfaces, srv, GetMap)() {
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap__handle;
}
